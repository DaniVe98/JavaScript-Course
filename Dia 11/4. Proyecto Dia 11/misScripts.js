function cargarResumen(){
  ...
  .then(function(salida){
    ...
    document.getElementById("usd").textContent = salida.saldo[0].monto + " " 
                                              +  salida.saldo[0].moneda;
    document.getElementById("eur").textContent = salida.saldo[1].monto + " " 
                                              +  salida.saldo[1].moneda;
